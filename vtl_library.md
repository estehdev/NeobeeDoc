...
### stripDiacritics(String input)
Replaces accented characters with their plain ASCII equivalents. Covers all accented Latin letters across languages (à, é, ñ, ü, č, ć, š, ž, ...) as well as stroke letters and ligatures (đ, ø, ł, ß, æ, œ).

#### Example
vtl: `$library_text.stripDiacritics('Đačić šeta')`

response: "Dacic seta"

&nbsp;

### asciiLettersDigits(String input)
Keeps only ASCII letters and digits; removes spaces, punctuation and everything else. Combine with `stripDiacritics` first to keep accented letters as ASCII.

#### Example
vtl: `$library_text.asciiLettersDigits('Café 123!')`

response: "Caf123"

&nbsp;

### asciiLettersDigitsSpaces(String input)
Keeps ASCII letters, digits and spaces; removes punctuation and everything else, preserving word separation.

#### Example
vtl: `$library_text.asciiLettersDigitsSpaces('Café 123!')`

response: "Caf 123"

&nbsp;

### asciiPrintable(String input)
Keeps any printable ASCII character (letters, digits, punctuation and space, 0x20-0x7E); removes control characters and any non-ASCII character.

#### Example
vtl: `$library_text.asciiPrintable('Café!')`

response: "Caf!"

&nbsp;

### asciiAll(String input)
Keeps all ASCII characters including control characters (0x00-0x7F); drops anything above code point 127 (non-ASCII).

#### Example
vtl: `$library_text.asciiAll('Café!')`
